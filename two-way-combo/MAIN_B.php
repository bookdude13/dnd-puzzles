<html>
 <head>
	...
	<div class="row">
		<div class="column">
			<img id="Stone_A" src="whitestones/protection.png" style="width:50%"></img>
		</div>
		<div class="column">
			<img id="Stone_2" src="whitestones/return.png" style="width:50%"></img>
		</div>
		<div class="column">
			<img id="Stone_3" src="whitestones/love.png" style="width:50%"></img>
		</div>
		<div class="column">
			<img id="Stone_4" src="whitestones/death.png" style="width:50%"></img>
		</div>
	</div> 
	...
	<script type="text/javascript">
		...
		{
			var s = document.createElement("script");
			s.src = "write_storage_A.php?x=" + JSON.stringify(arr);
			document.body.appendChild(s);
		};
		...
		{
			var answer = {"A":4,"B":5,"C":3,"D":1};
			if(myObj["A"] == answer["A"] && myObj["B"] == answer["B"] && myObj["C"] == answer["C"] && myObj["D"] == answer["D"])
			{
				write_storage_S({"data":1,"index":"B"});
			}
			else
			{
				write_storage_S({"data":0,"index":"B"});
			};
			var images = {
